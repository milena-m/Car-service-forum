...
<html>
    ...
    <body>
        <div class="container">
            <button class="btn" onclick="location.href = 'forum_page.php';">Forum</button>
            ...
            if (isset($_POST['save_changes'])) {
                ...
                if (!empty($first_name_input) && !empty($last_name_input) && !empty($password_input) && !empty($town_input) && !empty($email_input)) {
                    ...
                    $sql = "UPDATE user SET first_name = $first_name, last_name = $last_name, password = $password, town = $town, email = $email WHERE id = $user_id";
